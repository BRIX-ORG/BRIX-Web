...
const items = [
    {
        ...
        link: '#origin',
        title: 'THE BRIX ORIGIN',
        description:
            'Welcome to the era of authentic photography. Build your digital truth, block by block.',
    },
    {
        ...
        title: 'PURE REALITY',
        description:
            'Zero filters. Zero AI manipulation. Every shot is a raw fragment of time captured forever.',
    },
    {
        ...
        title: 'GEO-STAMPED',
        description:
            'Every "Brix" is anchored in space and time using precise GPS metadata and MapCN integration.',
    },
    {
        ...
        description:
            'Secure your legacy. Premium photos are hashed and pushed to the blockchain for eternal proof.',
    },
    {
        ...
        title: 'ARTIST STUDIO',
        description:
            'A dedicated web hub for digital creators to verify their process and showcase authentic masterpieces.',
    },
    {
        ...
        title: 'CONNECT RAW',
        description:
            'Share your unfiltered life with friends. No social pressure, just real, unedited connections.',
    },
    {
        ...
        description:
            'The freedom to choose. Flexible cloud storage for daily snaps, or immutable on-chain archiving.',
    },
    {
        ...
        description:
            'The future of image ownership is here. Join BRIX and reclaim the truth in your lens.',
    },
];
        ...
        <div className="relative min-h-screen w-full bg-brix-bg-dark overflow-hidden">
            ...
            <div className="fixed top-24 left-6 z-40 max-w-sm">
                <h1 className="font-display text-4xl md:text-5xl font-black uppercase tracking-tighter leading-none mb-4">
                    Discover <span className="text-primary">BRIX</span>
                </h1>
                <p className="text-sm text-muted-foreground font-mono">
                    Drag to explore • Click to learn more
                </p>
            </div>
            ...
            <div className="fixed bottom-6 left-6 right-6 z-40 flex items-end justify-between pointer-events-none">
                <div className="bg-background/30 backdrop-blur-md border border-border/50 p-4 pointer-events-auto">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-mono text-green-500">NETWORK ONLINE</span>
                    </div>
                </div>
